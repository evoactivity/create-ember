...
interface Language {
  welcomeMessage: LanguageItem;
  projectName: LanguageItem;
  shouldOverwrite: LanguageItem;
  packageName: LanguageItem;
  needsTypeScript: LanguageItem;
  needsWarpDrive: LanguageItem;
  needsTests: LanguageItem;
  needsEslint: LanguageItem;
  needsPrettier: LanguageItem;
  needsStylelint: LanguageItem;
  needsTemplateLint: LanguageItem;
  needsGit: LanguageItem;
  needsQunit: LanguageItem;
  needsVitest: LanguageItem;
  needsTailwind: LanguageItem;
  needsContinuousIntegration: LanguageItem;
  invalidPackageName: LanguageItem;
  linting: LanguageItem;
  testing: LanguageItem;
  creatingProject: LanguageItem;
  projectCreated: LanguageItem;
  installingDependencies: LanguageItem;
  dependenciesInstalled: LanguageItem;
  nextSteps: LanguageItem;
  featureSelection: LanguageItem;
  templateSelection: LanguageItem;
}
